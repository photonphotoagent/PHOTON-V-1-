...
export const LightBoxIcon: React.FC<{ className?: string }> = ({ className }) => (
...
export const WrenchScrewdriverIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" d="M13.5 21v-3.375A3.375 3.375 0 0 0 10.125 14.25H4.5A2.25 2.25 0 0 1 2.25 12v-2.25A2.25 2.25 0 0 1 4.5 7.5h7.5A2.25 2.25 0 0 1 14.25 9.75v2.25a2.25 2.25 0 0 1-2.25 2.25H10.5m-3-6.75h3M10.5 12.75h3m-3-3.75h3m6.75-3.375c.621 0 1.125.504 1.125 1.125V12a1.125 1.125 0 0 1-1.125 1.125H16.5m-3.375-3.375v3.375c0 .621.504 1.125 1.125 1.125h.008c.621 0 1.125-.504 1.125-1.125V8.625c0-.621-.504-1.125-1.125-1.125H16.5m-3.375 0h3.375" />
    </svg>
);
...
export const PinterestIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} stroke="currentColor" fill="currentColor" viewBox="0 0 24 24">
        <path d="M12.017 21.492c-2.612 0-4.83-1.424-5.485-3.626l-.337-1.122c-.21-.703-.18-1.55.083-2.27l1.11-2.923c.31-.818.1-1.748-.522-2.37l-1.12-1.12c-.54-.54-.77-1.32-.58-2.08.33-1.34 1.68-2.48 3.1-2.73 1.42-.25 2.82.26 3.73 1.32l.74.87c.33.39.81.6 1.3.6h.01c.5 0 .97-.22 1.3-.6l.74-.87c.9-1.06 2.3-1.57 3.73-1.32 1.42.25 2.77 1.39 3.1 2.73.19.76-.04 1.54-.58 2.08l-1.12 1.12c-.622.622-.832 1.552-.522 2.37l1.11 2.923c.263.72.293 1.567.083 2.27l-.337 1.122c-.655 2.202-2.873 3.626-5.485 3.626a5.13 5.13 0 0 1-1.04-.11" />
    </svg>
);
...
export const DollarSignIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 6v12m-3-2.818.879.659c1.171.879 3.07.879 4.242 0 1.172-.879 1.172-2.303 0-3.182C13.536 11.21 12.768 11 12 11c-.768 0-1.536.21-2.121.659-.955.715-1.585 1.85-1.585 3.021V15M3 7.5h18M3 12h18m-3 4.5h3" />
    </svg>
);
...
export const ScissorsIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" d="M7.848 8.25l1.536 1.536m-1.536-1.536l1.536-1.536m-1.536 1.536H3m15 0h-4.848m-2.22 5.25l-1.536 1.536m1.536-1.536l-1.536-1.536m1.536 1.536v4.848m-5.322-9.648a4.5 4.5 0 10-6.364 6.364m12.728-6.364a4.5 4.5 0 010 6.364m-6.364-3.182a2.25 2.25 0 012.25 2.25c0 1.242-.93 2.34-2.126 2.474a2.25 2.25 0 01-2.374-2.126 2.25 2.25 0 012.25-2.25z" />
    </svg>
);

export const PaintBrushIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" d="M9.53 16.122a3 3 0 00-5.78 1.128 2.25 2.25 0 01-2.475 2.118A2.25 2.25 0 007.5 21H9a2.25 2.25 0 002.25-2.25v-9A2.25 2.25 0 009 7.5H7.5a2.25 2.25 0 00-2.25 2.25v2.862m9.53-4.487a3 3 0 00-5.78-1.128 2.25 2.25 0 01-2.475-2.118A2.25 2.25 0 007.5 3H9a2.25 2.25 0 002.25 2.25v9A2.25 2.25 0 0013.5 16.5h1.5a2.25 2.25 0 002.25-2.25v-2.862z" />
    </svg>
);
...
export const RectangleStackIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" d="M6.429 9.75L2.25 12l4.179 2.25m0-4.5l5.571 3 5.571-3m-11.142 0L2.25 7.5 12 2.25l9.75 5.25-5.571 3m-5.571 0l5.571 3m0 0l5.571-3m0 0l4.179-2.25L12 21.75l-9.75-5.25 4.179-2.25m11.142 0l-5.571 3-5.571-3" />
    </svg>
);
...
export const SplitToningIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
      <circle cx="12" cy="12" r="9" strokeLinecap="round" strokeLinejoin="round" />
      <path strokeLinecap="round" strokeLinejoin="round" d="M12 3a9 9 0 0 1 9 9 9 9 0 0 1-9 9" />
    </svg>
);

export const CurvesIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
      <path strokeLinecap="round" strokeLinejoin="round" d="M3 21h18M3 21V3m0 18c6-12 12-6 18-18" />
    </svg>
);

export const EyeDropperIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
      <path strokeLinecap="round" strokeLinejoin="round" d="M15 11.25l-3-3m0 0l-3.75 3.75M8.25 8.25l-3.75 3.75m9.75-9.75l1.875 1.875c.966.966.966 2.534 0 3.5l-2.063 2.063m-1.312-1.313L9.19 14.81c-.557.557-1.332.846-2.12.79a8.254 8.254 0 01-5.07-2.072 8.254 8.254 0 01-2.072-5.07c-.056-.788.233-1.563.79-2.12l4.896-4.896m1.313 1.313l2.062 2.062" />
    </svg>
);
